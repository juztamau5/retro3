...
import { VideoView, VideoViewEvent } from '@retroai/retro3-models'
...
import {
  ...
  saveVolumeInStore
} from '../../retro3-player-local-storage'
import { Retro3PluginOptions } from '../../types'
import { SettingsButton } from '../settings/settings-menu-button'

const debugLogger = debug('retro3:player:retro3')

const Plugin = videojs.getPlugin('plugin')

class Retro3Plugin extends Plugin {
  ...
  constructor (player: videojs.Player, private readonly options: Retro3PluginOptions) {
    super(player)
  ...
  private updateControlBar () {
    ...
    if (this.options.isLive()) {
      ...
      this.player.controlBar.getChild('retro3LiveDisplay').show()
    } else {
      ...
      this.player.controlBar.getChild('retro3LiveDisplay').hide()
    }
...
videojs.registerPlugin('retro3', Retro3Plugin)
export { Retro3Plugin }
