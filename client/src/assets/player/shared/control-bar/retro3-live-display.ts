...
class Retro3LiveDisplay extends ClickableComponent {
  private interval: any

  private contentEl_: any

  constructor (player: videojs.Player, options?: Retro3LinkButtonOptions) {
...
videojs.registerComponent('Retro3LiveDisplay', Retro3LiveDisplay)
